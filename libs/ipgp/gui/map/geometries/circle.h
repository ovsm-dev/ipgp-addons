...
#ifndef __IPGP_GUI_MAP_CIRCLE_H__
#define __IPGP_GUI_MAP_CIRCLE_H__
...
class SC_IPGP_GUI_API Circle : public Geometry {
	...
	public:
		...
		//  Instruction
		// ------------------------------------------------------------------
		explicit Circle(const Map::ElementPosition& = Map::Middle);
		~Circle();
