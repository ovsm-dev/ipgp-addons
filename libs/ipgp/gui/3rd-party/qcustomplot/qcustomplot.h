...
public:
  ...
  */
  ...
  enum ScatterShape { ssNone       ///< no scatter symbols are drawn (e.g. in QCPGraph, data only represented with lines)
                      ...
                      ,ssFilledSquare //! @brief Very usefull ;)
...
public:
  ...
  */
  enum LabelType { ltNumber    ///< Tick coordinate is regarded as normal number and will be displayed as such. (see \ref setNumberFormat)
                   ...
                   ,ltDateTimeAuto //! @note this is to be used with caution
  	  	  	  	  };
  Q_ENUMS(LabelType)
  /*!
...
public:
  ...
  //! Don't know why they removed this...
...
public:
  ...
  */
  ...
  //! @author Stephen Roselia
  //! @brief  Don't know why they removed this... It provides a great tooltip
  //!         interface to get mouse position over graph
  const int graphAt(const QPoint& pos, bool onlySelectable) const;
